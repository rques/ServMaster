document.addEventListener("DOMContentLoaded", () => {
    ...
    loginForm.addEventListener("submit", (e) => {
        ...
        // Verifica se o cargo é realmente técnico
        if (usuarioValido.cargo !== 'tecnico') {
            mostrarErro("Acesso negado. Este portal é exclusivo para Técnicos.");
            return;
        }
        ...
        sessionStorage.setItem("nomeTecnico", usuarioValido.nome); // Opcional, para usar no painel

        setTimeout(() => {
            window.location.href = "../painel-tecnico/painel-tecnico.html"; 
        }, 1000);
    });
